        ...
        <View style={styles.formCard}>
          ...
          <View style={styles.inputGroup}>
            ...
            <View style={styles.dropdownField}>
              <TextInput placeholder="Ex : BYD" placeholderTextColor="#999" style={styles.inputText} />
          ...
          <View style={styles.inputGroup}>
            ...
            <View style={styles.dropdownField}>
              <TextInput placeholder="Ex : seal" placeholderTextColor="#999" style={styles.inputText} />
              <MaterialIcons name="keyboard-arrow-down" size={24} color="white" />
            </View>
          </View>
          ...
          <View style={styles.inputGroup}>
            ...
            <View style={styles.dropdownField}>
              <TextInput placeholder="Ex : Type 2" placeholderTextColor="#999" style={styles.inputText} />
              <MaterialIcons name="keyboard-arrow-down" size={24} color="white" />
            </View>
          </View>
          ...
          <View style={styles.inputGroup}>
            ...
            <View style={styles.inputField}>
              <TextInput placeholder="Ex : 2025" placeholderTextColor="#999" style={styles.inputText} />
            </View>
          </View>
          ...
          <View style={styles.inputGroup}>
            ...
            <View style={styles.inputField}>
              <TextInput placeholder="Ex : 45kWh" placeholderTextColor="#999" style={styles.inputText} />
            </View>
          </View>
