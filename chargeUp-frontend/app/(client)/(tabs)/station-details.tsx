...
const styles = StyleSheet.create({
  ...
  bottomSheet: { flex: 1, marginTop: 60, borderTopLeftRadius: 30, borderTopRightRadius: 30, padding: 20 },
  header: { alignItems: 'center', marginBottom: 25 },
  mainTitle: { color: 'white', fontSize: 24, fontWeight: 'bold', marginTop: 10, textAlign: 'center' },
  card: { backgroundColor: 'rgba(28, 46, 51, 0.8)', borderRadius: 15, padding: 15, marginBottom: 15, borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)' },
  cardType: { color: 'white', fontSize: 15, marginBottom: 15 },
  footer: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  badge: { borderWidth: 1, paddingHorizontal: 10, paddingVertical: 3, borderRadius: 10 },
  badgeText: { fontSize: 11, fontWeight: 'bold' },
  infoButton: { backgroundColor: '#3A4B4E', paddingHorizontal: 20, paddingVertical: 5, borderRadius: 12, borderWidth: 1, borderColor: 'white' },
